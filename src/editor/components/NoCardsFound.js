...
const NoCardsFound = () => {
    return(
        <View style={styles.container}>
            <ErrorAlert height={20} width={20} style={styles.errorIcon}></ErrorAlert>
            <View style={[styles.container2, styles.alignFlexStart]}>
                <Text style={[styles.fontFamilyMulish, styles.text1]}> No cards found</Text>
                <Text style={styles.fontFamilyMulish, styles.text2}> Please try again.</Text>
            </View>
