...
import { StyleSheet, SafeAreaView, View, ScrollView, TouchableWithoutFeedback, Keyboard } from 'react-native';
  ...
  return (
    <SafeAreaView style={{ backgroundColor: '#FFFAF5' }}>
      ...
      <ScrollView style={styles.scrollView}>
        <TouchableWithoutFeedback onPress={Keyboard.dismiss} backgroundColor={"orange"}>
